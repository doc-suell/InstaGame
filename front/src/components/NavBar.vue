    ...
    <!-- <div v-if="isUserConnected"> -->
        <nav>
            <div class="navigation">
                <!-- LOGO HOME  -->
                <router-link class="logo" to="/"><svg xmlns="http://www.w3.org/2000/svg" height="40px"
                        viewBox="0 0 512 512">
                        <defs>
                ...
                <ul class="u-navigation">
                    <!-- HOME LINK  -->
                    <li class="nav-item">
                        <router-link class="link-item" to="/"><svg xmlns="http://www.w3.org/2000/svg" height="25px"
                                viewBox="0 0 576 512">
                                <path
                    ...
                    <!-- ADD POST LINK  -->
                    <li class="nav-item">
                        <span @click="openModal" class="link-item creat-post-btn" to="/create"><svg
                                xmlns="http://www.w3.org/2000/svg" height="25px" viewBox="0 0 448 512">
                                <path
        ...
        <div id="modal" class="modal hidden">
            <ul>
                <router-link to="/profil" id="link-modal" class="link-modal">
                    ...
                    <span class="pl-[6px]">Profile</span>
                    <!-- <router-link to="/profil">Profile</router-link> -->
                </router-link>
                <router-link  to="#" @click="logout" class="link-modal">
